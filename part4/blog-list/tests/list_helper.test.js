...
describe('total likes', () => {
    ...
    test('using a list with more blogs', () => {
...
describe('Most Blog', () => {
    ...
    test('Test with modified array', () => {
      const result = listHelper.mostBlogs(blogs.slice(0,3))
